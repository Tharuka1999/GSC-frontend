function DOPUpperBox() {
    return (
      <div className="bg-[#011C3F] md:w-[500px] px-1 text-white font-catamaran rounded-[8px] ml-5 mr-2 py-1">
        <div className="">
          <p className=" ml-[2%] text-[13px] sm:text-[18px] font-medium">Entry Requirements</p>
          <ul className=" ml-[6%] mt-[3px] text-[12px] sm:text-[16px] font-regular">
            <li>Any recognized bachelor degree in management related or IBSL pass finalized</li>
          </ul>
        </div>
      </div>
    );
